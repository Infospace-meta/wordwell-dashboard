        ...
        <thead>
          <tr class="border-b border-slate-200 bg-slate-50/50">
            <th class="px-6 py-3 text-left">
              <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Order</span>
            </th>
            <th class="px-6 py-3 text-left">
              <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Deadline</span>
            </th>
            <th class="px-6 py-3 text-left">
            ...
            <th class="px-6 py-3 text-left">
              <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Payment</span>
            </th>
        ...
        <tbody class="divide-y divide-slate-100">
          ...
          >
            ...
            <td class="px-6 py-5">
              <span :class="[
                'px-2.5 py-1 rounded-full text-xs font-medium',
                order.payment === 'Paid' ? 'bg-blue-100 text-blue-700' : 'bg-slate-100 text-slate-700'
              ]">
                {{ order.payment }}
              </span>
            </td>
            ...
            <td class="px-6 py-5 text-right">
              <div class="flex items-center justify-end gap-2">
                <button class="px-4 py-2 text-sm rounded-lg text-neutral-500 border border-neutral-300 hover:cursor-pointer hover:text-blue-800 hover:border-blue-800 transition-all duration-200 flex items-center gap-1">
                  View
                </button>
                <button
