<template>
  <div
    class="bg-white rounded-xl border border-gray-200 h-[50vh] flex flex-col overflow-hidden"
  >
    <!-- Header – smaller & cleaner -->
    <div
      class="px-4 py-3 border-b border-gray-200 flex items-center justify-between bg-gray-50/80"
    >
    ...
    <div class="flex-1 overflow-y-auto px-4 py-4 space-y-5 text-sm">
      ...
      <section>
        ...
        <div class="bg-gray-50 rounded-lg p-3 border border-gray-100">
          <p class="font-medium text-gray-900 text-[0.93rem]">
            {{ order.user.full_name }}
          </p>
          <p class="text-gray-600 mt-0.5 text-[0.93rem]">
            {{ order.user.email }}
          </p>
          <p
            class="mt-1 flex items-center gap-1.5 text-gray-600 text-[0.93rem]"
          >
      ...
      <!-- Price & Status -->
      <section
        class="bg-emerald-50/40 rounded-lg p-3 border border-emerald-100/60"
      >
      ...
      <section>
        <h3 class="text-xs font-semibold uppercase text-gray-500 mb-1.5">
          ...
          <span
            v-if="isEditing"
            class="text-indigo-600 text-xs normal-case font-normal"
            >(editing)</span
          >
        </h3>
        ...
        <div class="grid grid-cols-2 gap-x-5 gap-y-3">
          <div>
            ...
            <dd class="mt-0.5">
              ...
              />
              <span v-else class="font-medium capitalize">{{
                order.service_type
              }}</span>
            </dd>
          </div>
          ...
          <div>
            ...
            <dd class="mt-0.5">
              ...
              <span v-else class="font-medium uppercase">{{
          ...
          <div>
            ...
            <dd class="mt-0.5">
              ...
              <span v-else class="font-medium">
                {{
                  new Date(order.deadline).toLocaleString("en-KE", {
                    dateStyle: "medium",
                    timeStyle: "short",
                  })
                }}
      ...
      <section v-if="order.instructions?.trim() || isEditing">
        ...
        <div
          v-else
          class="bg-gray-50 rounded-lg p-3 border border-gray-100 text-gray-700 leading-relaxed whitespace-pre-wrap text-[0.93rem]"
        >
          {{ order.instructions }}
        </div>
      </section>
    ...
    <div
      class="border-t border-gray-200 px-4 py-3 bg-gray-50 flex flex-wrap gap-3 justify-end"
    >
